...
export class Initial1711222494192 implements MigrationInterface {
  name = 'Initial1711222494192';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "post_reaction_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "reaction" character(1) NOT NULL, "count" integer NOT NULL DEFAULT '0', "statsId" uuid, CONSTRAINT "UQ_cb778139b91fdbecdba84c43cf6" UNIQUE ("reaction"), CONSTRAINT "PK_174547b3ce9e7af7aefea321883" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "post_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "text" text NOT NULL DEFAULT '', "ttl" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_58a149c4e88bf49036bc4c8c79f" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "post_stats_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "likes" integer NOT NULL DEFAULT '0', "dislikes" integer NOT NULL DEFAULT '0', "postId" uuid, CONSTRAINT "REL_86f18c93315192e709e4836102" UNIQUE ("postId"), CONSTRAINT "PK_0178a40c671bd0c54c488660d96" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
